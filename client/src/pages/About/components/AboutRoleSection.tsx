...
const AboutRoleSection = (props: AboutRoleSectionProps) => {
    ...
    return (
        <section className="relative w-full lg:w-2/3">
            <div className="border-primary/20 from-primary/10 to-secondary/10 rounded-2xl border bg-linear-to-r text-center">
                <h2 className="text-fluid-2.5! mb-4 font-bold tracking-tight">
                    {isAdmin
                        ? "Admin Dashboard Access"
                        : "Your ClarityBox Experience"}
                </h2>
                <p className="text-muted-foreground text-fl text-fluid-1.25! mx-auto! mb-8 w-[90%]">
                    {isAdmin
                ...
                <div className="my-6! flex h-96 max-h-[50px] flex-col items-center justify-center gap-3 sm:flex-row">
                    <Button
                        onClick={() =>
